...
public class IterableMain {
	public static void main(String[] args) {
		...
		//Iterator
		Iterator<String> iteratorAnimales = animales.iterator();
		while(iteratorAnimales.hasNext()) {
			String elemento2 = iteratorAnimales.next();
			System.out.println(elemento2);
		}
		
		//For-Each
		for (String animalesForEach : animales) {
			System.out.println(animalesForEach);
		}
	}
}
